	...
	<footer class="footer">
		<article class="inner-footer">
			...
			<section class="footer-items">
				...
				<ul>
					<a href="http://127.0.0.1/GRIVOTECH-MAIN/index.php"><li>Home</li></a>
					<a href="#"><li>About Us</li></a>
					<a href="https://matrusri.edu.in/"><li>College</li></a>
			...
			<section class="footer-items">
				...
				<div class="border"></div>
				<ul>
					<a href="https://matrusri.edu.in/"><li>Matrusri Engineering College</li></a>
			...
			<section class="footer-items">
				...
				<div class="border"></div>
				<ul>
					<li><i class="fa fa-map-marker" aria-hidden="true"></i>Saidabad, Hyderabad, Telangana</li>
					<li><i class="fa fa-phone" aria-hidden="true"></i>9701406397</li>
