...
if (strlen($_SESSION['alogin']) == 0) {
	...
	if (isset($_POST['submit'])) {
		...
		$query = mysqli_query($db, "insert into facultycomplain(userId,grievanceId,complain,proof,isAnonymous) values('$uid','$grievance','$complain','$name','$isAnonymous')");
...
?>
	...
	<head>
		...
		<title>Register New Grievance | MECS-ConnectX</title>
		<!-- Bootstrap Core CSS -->
									...
									<div class="form-group">
										...
										<div class="col-md-8">
											...
											<select name="grievance" id="grievanceType" class="selectStyle col-md-12" required="">
												...
												<?php $sql = mysqli_query($db, "select id,categoryName from facultycategory ");
