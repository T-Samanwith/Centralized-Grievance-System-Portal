		...
		<div class="container" style=" width: 97%;">
			<div class="row">
				...
				<div class="list-group">
							...
							<!-- <a href="parentGrievance.php" class="list-group-item"><span class="glyphicon glyphicon-list-alt" aria-hidden="true"></span> Parent Grievance <span class="badge"></span></a> -->
