...
<head>
	...
	<title>Dashboard | MECS-ConnectX</title>
		...
		<div class="container" style="margin-top: 2% ; width: 97%;">
			<ol class="breadcrumb">
				<li><input type="button" value="Back" onclick="history.go(-1)"></li>
			 	...
			 	<li><a href="facultyGrievance.php" style="text-decoration: none;">Faculty Grievance Menu</a></li>
			 	<li class="active">Faculty Grievance | Normal Grievance Overview</li>
			</ol>
		</div>
	</section>
...
<a href="facultyGrievance.php" class="list-group-item"><span class="glyphicon glyphicon-list-alt" aria-hidden="true"></span> Faculty Grievance <span class="badge"></span></a>
				...
				<div class="col-md-10">
					...
					<div class="panel panel-default">
						<div class="panel-heading main-color-bg">
							<h3 class="panel-title">Faculty Grievance | Normal Grievance Overview</h3>
						</div>
...
<?php 
$status="in process";
$query=mysqli_query($db,"SELECT facultycomplain.*,academy.name AS name FROM facultycomplain JOIN academy ON academy.id=complain.userId WHERE facultycomplain.status='$status' ");
