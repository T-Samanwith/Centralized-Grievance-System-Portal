...
<head>
	<meta charset="utf-8">
	<link rel="icon" type="image/png" href="assets/img/logoMECS-ConnectX.png">
	<title>Login | Admin | MECS-ConnectX</title>
	...
	<article class="login-page">
		<section class="form">
			<form class="student-form" method="post">
				...
				<fieldset>
					<legend>Admin | Login | MECS-ConnectX</legend><br>
			...
			<form class="reset-password">
				<fieldset>
					<legend>Admin | Reset Password | MECS-ConnectX</legend><br>
